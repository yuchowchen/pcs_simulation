...
pub struct MutablePcsData {
    ...
    pub pcs_all_lan1: DashMap<u16, SubscriberPCSData>,
    pub pcs_all_lan2: DashMap<u16, SubscriberPCSData>,
}
...
impl ProcessData {
    ...
    pub fn init_from_nameplates<P: AsRef<std::path::Path>>(&mut self, path: P) -> Result<()> {
        ...
        for config in nameplate_configs {
            ...
            // Create SubscriberPCSData instance
    ...
    pub fn get_pcs_data_by_lan(&self, lan_id: u8) -> Vec<SubscriberPCSData> {
        match lan_id {
    ...
    /// lan_id: 1 for LAN1, 2 for LAN2
    /// Returns a reference guard that dereferences to SubscriberPCSData
    pub fn get_pcs_by_logical_id(&self, logical_id: u16, lan_id: u8) -> Option<dashmap::mapref::one::Ref<'_, u16, SubscriberPCSData>> {
        match lan_id {
    ...
    /// lan_id: 1 for LAN1, 2 for LAN2
    /// Returns a mutable reference guard that dereferences to SubscriberPCSData
    pub fn get_pcs_by_logical_id_mut(&mut self, logical_id: u16, lan_id: u8) -> Option<dashmap::mapref::one::RefMut<'_, u16, SubscriberPCSData>> {
        match lan_id {
    ...
    pub fn get_pcs_by_logical_id_both_lans(&self, logical_id: u16) -> (Option<dashmap::mapref::one::Ref<'_, u16, SubscriberPCSData>>, Option<dashmap::mapref::one::Ref<'_, u16, SubscriberPCSData>>) {
    ...
    /// lan_id: 1 for LAN1, 2 for LAN2
    /// Returns a reference guard that dereferences to SubscriberPCSData
    pub fn get_pcs_by_appid(&self, appid: u16, lan_id: u8) -> Option<dashmap::mapref::one::Ref<'_, u16, SubscriberPCSData>> {
        match lan_id {
            1 => {
                if let Some(&(logical_id, ref _pcs_type)) = self.appid_index.appid_to_logical_lan1.get(&appid) {
    ...
    /// lan_id: 1 for LAN1, 2 for LAN2
    /// Returns a mutable reference guard that dereferences to SubscriberPCSData
    pub fn get_pcs_by_appid_mut(&mut self, appid: u16, lan_id: u8) -> Option<dashmap::mapref::one::RefMut<'_, u16, SubscriberPCSData>> {
        match lan_id {
            1 => {
    ...
    pub fn get_pcs_by_appid_both_lans(&self, appid: u16) -> (Option<dashmap::mapref::one::Ref<'_, u16, SubscriberPCSData>>, Option<dashmap::mapref::one::Ref<'_, u16, SubscriberPCSData>>) {
    ...
    pub fn add_pcs_to_lan1(&mut self, logical_id: u16, pcs: SubscriberPCSData) {
    ...
    pub fn add_pcs_to_lan2(&mut self, logical_id: u16, pcs: SubscriberPCSData) {
        // Build APPID index if nameplate has APPID
        if let Some(appid) = pcs.nameplate_appid() {
...
impl MutablePcsData {
    ...
    pub fn recalculate_totals_by_lan(&self, lan_id: u8) -> (f32, f32) {
        ...
        fn extract_power_values(pcs: &SubscriberPCSData) -> Option<(f32, f32)> {
