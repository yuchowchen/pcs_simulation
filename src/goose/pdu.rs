...
use crate::goose::pdu_decoder::*;
use crate::goose::pdu_encoder::*;

use std::time::{SystemTime, UNIX_EPOCH};

pub fn encodeGooseFrame(
...
pub fn getTimeMs() -> [u8; 8] {
    ...
    let since_the_epoch = match start
        .duration_since(UNIX_EPOCH) {
            Ok(duration) => duration,
        Err(_) => {
            // Handle the rare case where time goes backwards
            // Return a minimal duration (0 seconds)
